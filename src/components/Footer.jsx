...
const Footer = () => {
  return (
    <div style={{height:"400px",width:"100%"}} className='d-flex flex-column align-items-center justify-content-center mt-5 shadow'>
    <div className="d-flex justify-content-evenly w-100">
      <div className="intro" style={{width:"400px"}}>
          <h5 className='head'><i className='fa-solid fa-diagram-project me-1'></i>Project Fair</h5>
